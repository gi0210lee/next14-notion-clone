...
const Navigation = () => {
  ...
  const handleCreate = () => {
    ...
    toast.promise(promise, {
      ...
      error: "Failed to craete a new note.",
    });
  };
  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={cn(
          "group/sidebar relative z-[5] flex h-full w-60 flex-col overflow-y-auto bg-secondary",
      ...
      <div
        ref={navbarRef}
        className={cn(
          "absolute left-60 top-0 z-[5] w-[calc(100%-240px)]",
          isResetting && "translation-all duration-300 ease-in-out",
